...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/mpdecimal-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/mpdecimal-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
Installing `libmpdec` from the `conda-forge` channel can be achieved by adding `conda-forge` to your channels with:
...
Updating libmpdec-feedstock
===========================

If you would like to improve the libmpdec recipe or build a new
...
Note that all branches in the conda-forge/libmpdec-feedstock are
