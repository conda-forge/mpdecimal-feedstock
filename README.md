...
pixi add libmpdec libmpdec-devel libmpdecxx libmpdecxx-devel
# for installing globally
pixi global install libmpdec libmpdec-devel libmpdecxx libmpdecxx-devel
```
...
It is possible to list all of the versions of `libmpdec` available on your platform:
...
```
pixi search libmpdec --channel conda-forge
```
